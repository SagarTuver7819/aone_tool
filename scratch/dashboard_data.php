...
try {
    ...
    $comparisons = [
        ...
        'sessions' => getComparison($cmp_current['total_sessions'], $totals_prev['total_sessions']),
        'conv' => getComparison($cmp_current['avg_conversion'] ?? 0, $totals_prev['avg_conversion'] ?? 0),
        'refunds' => getComparison($cmp_current['avg_refund_rate'] ?? 0, $totals_prev['avg_refund_rate'] ?? 0),
