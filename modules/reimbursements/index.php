...
<script>
    $(document).ready(function () {
        ...
        let reimbDatePicker = null;
        function initReimbDatePicker(from, to) {
            if (typeof flatpickr === 'undefined') return;
            if (reimbDatePicker) {
                try { reimbDatePicker.destroy(); } catch (e) { /* ignore */ }
            }
            reimbDatePicker = flatpickr("#date_range_picker_reimb", {
                mode: "range",
                dateFormat: "Y-m-d",
                altInput: true,
                altFormat: "M d, Y",
        ...
        $('#apply_filters').on('click', loadData);
        $('#filter_customer').on('change', bootReimbDates);
